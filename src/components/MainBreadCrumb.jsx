...
export default function MainBreadcrumb() {
  ...
  return (
    <section
      className="relative bg-cover bg-center h-96 flex items-center justify-center text-white bg-gradient-to-r from-slate-900 to-slate-700"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-4 leading-tight">
          Begin Your Journey, <span className="text-themeClr">With Deeds Consultants</span>
        </h1>
        <Link to='/form'>
